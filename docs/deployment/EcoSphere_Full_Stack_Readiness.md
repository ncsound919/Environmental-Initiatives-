...
- **Deployment:** Favor `docker-compose up` for end-to-end bring-up (Keycloak, Kafka, API, web). Ensure `.env` includes broker URLs, PostgreSQL/Neo4j/Redis endpoints, and Keycloak realm settings matching the EcoSphere defaults.
